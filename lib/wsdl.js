...
WSDL.prototype._initializeOptions = function (options) {
  ...
  this.options.extraSoapHeaders = options.extraSoapHeaders;
...
WSDL.prototype.xmlToObject = function(xml, callback) {
  ...
  function finish() {
    ...
    if (root.Envelope) {
      ...
      if (body && body.Fault) {
        var code = selectn('faultcode.$value', body.Fault) || selectn('faultcode', body.Fault) || selectn('Code.Value', body.Fault);
        var string = selectn('faultstring.$value', body.Fault) || selectn('faultstring', body.Fault) || selectn('Reason.Text.$value', body.Fault);
